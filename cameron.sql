...
--
-- Hôte : localhost:3306
-- Généré le : ven. 02 avr. 2021 à 15:45
...
CREATE TABLE `artistes` (
  ...
  `artiste_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL
...
CREATE TABLE `assoc_artistes_styles` (
  ...
  `assoc_artiste_id` int NOT NULL,
  `assoc_style_id` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
ALTER TABLE `assoc_artistes_styles`
  ...
  ADD KEY `assoc_artistes_styles_ibfk_2` (`assoc_style_id`);
...
--
ALTER TABLE `artistes`
  MODIFY `artiste_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT pour la table `assoc_artistes_styles`
--
ALTER TABLE `assoc_artistes_styles`
  MODIFY `assoc_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `styles`
  MODIFY `style_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=593;
